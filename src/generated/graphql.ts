...
export type GetUsersQuery = { __typename?: 'Query', users: Array<{ __typename?: 'UserType', firstName: string, middleName: string, lastname: string, accountType: string, phoneNumber: string, username: string }> };
